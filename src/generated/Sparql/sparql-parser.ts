...
import SparqlListener from './sparql-listener';
...
export default class SparqlParser extends Parser {
  ...
  public get literalNames(): (string | null)[] {
    return SparqlParser.literalNames;
  }

  public get symbolicNames(): (string | null)[] {
    return SparqlParser.symbolicNames;
  }

  public get ruleNames(): string[] {
    return SparqlParser.ruleNames;
  }

  public get serializedATN(): number[] {
    return SparqlParser._serializedATN;
  }
  ...
  public query(): QueryContext {
    const localctx: QueryContext = new QueryContext(this, this._ctx, this.state);
  ...
  public prologue(): PrologueContext {
    const localctx: PrologueContext = new PrologueContext(this, this._ctx, this.state);
  ...
  public baseDecl(): BaseDeclContext {
    const localctx: BaseDeclContext = new BaseDeclContext(this, this._ctx, this.state);
  ...
  public prefixDecl(): PrefixDeclContext {
    const localctx: PrefixDeclContext = new PrefixDeclContext(this, this._ctx, this.state);
  ...
  public selectQuery(): SelectQueryContext {
    const localctx: SelectQueryContext = new SelectQueryContext(this, this._ctx, this.state);
  ...
  public constructQuery(): ConstructQueryContext {
    const localctx: ConstructQueryContext = new ConstructQueryContext(this, this._ctx, this.state);
  ...
  public describeQuery(): DescribeQueryContext {
    const localctx: DescribeQueryContext = new DescribeQueryContext(this, this._ctx, this.state);
  ...
  public askQuery(): AskQueryContext {
    const localctx: AskQueryContext = new AskQueryContext(this, this._ctx, this.state);
  ...
  public datasetClause(): DatasetClauseContext {
    const localctx: DatasetClauseContext = new DatasetClauseContext(this, this._ctx, this.state);
  ...
  public defaultGraphClause(): DefaultGraphClauseContext {
    const localctx: DefaultGraphClauseContext = new DefaultGraphClauseContext(this, this._ctx, this.state);
  ...
  public namedGraphClause(): NamedGraphClauseContext {
    const localctx: NamedGraphClauseContext = new NamedGraphClauseContext(this, this._ctx, this.state);
  ...
  public sourceSelector(): SourceSelectorContext {
    const localctx: SourceSelectorContext = new SourceSelectorContext(this, this._ctx, this.state);
  ...
  public whereClause(): WhereClauseContext {
    const localctx: WhereClauseContext = new WhereClauseContext(this, this._ctx, this.state);
  ...
  public solutionModifier(): SolutionModifierContext {
    const localctx: SolutionModifierContext = new SolutionModifierContext(this, this._ctx, this.state);
  ...
  public limitOffsetClauses(): LimitOffsetClausesContext {
    const localctx: LimitOffsetClausesContext = new LimitOffsetClausesContext(this, this._ctx, this.state);
  ...
  public orderClause(): OrderClauseContext {
    const localctx: OrderClauseContext = new OrderClauseContext(this, this._ctx, this.state);
    ...
    try {
      this.enterOuterAlt(localctx, 1);
      {
        ...
        do {
          ...
          ((_la & ~0x1f) === 0 && ((1 << _la) & 67207168) !== 0) ||
          (((_la - 45) & ~0x1f) === 0 && ((1 << (_la - 45)) & 903167) !== 0)
        );
      }
    } catch (re) {
      if (re instanceof RecognitionException) {
  ...
  public orderCondition(): OrderConditionContext {
    const localctx: OrderConditionContext = new OrderConditionContext(this, this._ctx, this.state);
  ...
  public limitClause(): LimitClauseContext {
    const localctx: LimitClauseContext = new LimitClauseContext(this, this._ctx, this.state);
  ...
  public offsetClause(): OffsetClauseContext {
    const localctx: OffsetClauseContext = new OffsetClauseContext(this, this._ctx, this.state);
  ...
  public groupGraphPattern(): GroupGraphPatternContext {
    const localctx: GroupGraphPatternContext = new GroupGraphPatternContext(this, this._ctx, this.state);
  ...
  public triplesBlock(): TriplesBlockContext {
    const localctx: TriplesBlockContext = new TriplesBlockContext(this, this._ctx, this.state);
  ...
  public graphPatternNotTriples(): GraphPatternNotTriplesContext {
    const localctx: GraphPatternNotTriplesContext = new GraphPatternNotTriplesContext(this, this._ctx, this.state);
  ...
  public optionalGraphPattern(): OptionalGraphPatternContext {
    const localctx: OptionalGraphPatternContext = new OptionalGraphPatternContext(this, this._ctx, this.state);
  ...
  public graphGraphPattern(): GraphGraphPatternContext {
    const localctx: GraphGraphPatternContext = new GraphGraphPatternContext(this, this._ctx, this.state);
  ...
  public groupOrUnionGraphPattern(): GroupOrUnionGraphPatternContext {
    const localctx: GroupOrUnionGraphPatternContext = new GroupOrUnionGraphPatternContext(this, this._ctx, this.state);
  ...
  public filter_(): Filter_Context {
    const localctx: Filter_Context = new Filter_Context(this, this._ctx, this.state);
  ...
  public constraint(): ConstraintContext {
    const localctx: ConstraintContext = new ConstraintContext(this, this._ctx, this.state);
  ...
  public functionCall(): FunctionCallContext {
    const localctx: FunctionCallContext = new FunctionCallContext(this, this._ctx, this.state);
  ...
  public argList(): ArgListContext {
    const localctx: ArgListContext = new ArgListContext(this, this._ctx, this.state);
  ...
  public constructTemplate(): ConstructTemplateContext {
    const localctx: ConstructTemplateContext = new ConstructTemplateContext(this, this._ctx, this.state);
  ...
  public constructTriples(): ConstructTriplesContext {
    const localctx: ConstructTriplesContext = new ConstructTriplesContext(this, this._ctx, this.state);
  ...
  public triplesSameSubject(): TriplesSameSubjectContext {
    const localctx: TriplesSameSubjectContext = new TriplesSameSubjectContext(this, this._ctx, this.state);
  ...
  public propertyListNotEmpty(): PropertyListNotEmptyContext {
    const localctx: PropertyListNotEmptyContext = new PropertyListNotEmptyContext(this, this._ctx, this.state);
  ...
  public propertyList(): PropertyListContext {
    const localctx: PropertyListContext = new PropertyListContext(this, this._ctx, this.state);
  ...
  public objectList(): ObjectListContext {
    const localctx: ObjectListContext = new ObjectListContext(this, this._ctx, this.state);
  ...
  public object_(): Object_Context {
    const localctx: Object_Context = new Object_Context(this, this._ctx, this.state);
  ...
  public verb(): VerbContext {
    const localctx: VerbContext = new VerbContext(this, this._ctx, this.state);
  ...
  public triplesNode(): TriplesNodeContext {
    const localctx: TriplesNodeContext = new TriplesNodeContext(this, this._ctx, this.state);
  ...
  public blankNodePropertyList(): BlankNodePropertyListContext {
    const localctx: BlankNodePropertyListContext = new BlankNodePropertyListContext(this, this._ctx, this.state);
  ...
  public collection(): CollectionContext {
    const localctx: CollectionContext = new CollectionContext(this, this._ctx, this.state);
  ...
  public graphNode(): GraphNodeContext {
    const localctx: GraphNodeContext = new GraphNodeContext(this, this._ctx, this.state);
  ...
  public varOrTerm(): VarOrTermContext {
    const localctx: VarOrTermContext = new VarOrTermContext(this, this._ctx, this.state);
  ...
  public varOrIRIref(): VarOrIRIrefContext {
    const localctx: VarOrIRIrefContext = new VarOrIRIrefContext(this, this._ctx, this.state);
  ...
  public var_(): Var_Context {
    const localctx: Var_Context = new Var_Context(this, this._ctx, this.state);
  ...
  public graphTerm(): GraphTermContext {
    const localctx: GraphTermContext = new GraphTermContext(this, this._ctx, this.state);
  ...
  public conditionalOrExpression(): ConditionalOrExpressionContext {
    const localctx: ConditionalOrExpressionContext = new ConditionalOrExpressionContext(this, this._ctx, this.state);
  ...
  public conditionalAndExpression(): ConditionalAndExpressionContext {
    const localctx: ConditionalAndExpressionContext = new ConditionalAndExpressionContext(this, this._ctx, this.state);
  ...
  public valueLogical(): ValueLogicalContext {
    const localctx: ValueLogicalContext = new ValueLogicalContext(this, this._ctx, this.state);
  ...
  public relationalExpression(): RelationalExpressionContext {
    const localctx: RelationalExpressionContext = new RelationalExpressionContext(this, this._ctx, this.state);
  ...
  public numericExpression(): NumericExpressionContext {
    const localctx: NumericExpressionContext = new NumericExpressionContext(this, this._ctx, this.state);
  ...
  public additiveExpression(): AdditiveExpressionContext {
    const localctx: AdditiveExpressionContext = new AdditiveExpressionContext(this, this._ctx, this.state);
  ...
  public multiplicativeExpression(): MultiplicativeExpressionContext {
    const localctx: MultiplicativeExpressionContext = new MultiplicativeExpressionContext(this, this._ctx, this.state);
  ...
  public unaryExpression(): UnaryExpressionContext {
    const localctx: UnaryExpressionContext = new UnaryExpressionContext(this, this._ctx, this.state);
  ...
  public primaryExpression(): PrimaryExpressionContext {
    const localctx: PrimaryExpressionContext = new PrimaryExpressionContext(this, this._ctx, this.state);
  ...
  public brackettedExpression(): BrackettedExpressionContext {
    const localctx: BrackettedExpressionContext = new BrackettedExpressionContext(this, this._ctx, this.state);
  ...
  public builtInCall(): BuiltInCallContext {
    const localctx: BuiltInCallContext = new BuiltInCallContext(this, this._ctx, this.state);
  ...
  public regexExpression(): RegexExpressionContext {
    const localctx: RegexExpressionContext = new RegexExpressionContext(this, this._ctx, this.state);
  ...
  public iriRefOrFunction(): IriRefOrFunctionContext {
    const localctx: IriRefOrFunctionContext = new IriRefOrFunctionContext(this, this._ctx, this.state);
  ...
  public rdfLiteral(): RdfLiteralContext {
    const localctx: RdfLiteralContext = new RdfLiteralContext(this, this._ctx, this.state);
  ...
  public numericLiteral(): NumericLiteralContext {
    const localctx: NumericLiteralContext = new NumericLiteralContext(this, this._ctx, this.state);
  ...
  public numericLiteralUnsigned(): NumericLiteralUnsignedContext {
    const localctx: NumericLiteralUnsignedContext = new NumericLiteralUnsignedContext(this, this._ctx, this.state);
  ...
  public numericLiteralPositive(): NumericLiteralPositiveContext {
    const localctx: NumericLiteralPositiveContext = new NumericLiteralPositiveContext(this, this._ctx, this.state);
  ...
  public numericLiteralNegative(): NumericLiteralNegativeContext {
    const localctx: NumericLiteralNegativeContext = new NumericLiteralNegativeContext(this, this._ctx, this.state);
  ...
  public booleanLiteral(): BooleanLiteralContext {
    const localctx: BooleanLiteralContext = new BooleanLiteralContext(this, this._ctx, this.state);
  ...
  public string_(): String_Context {
    const localctx: String_Context = new String_Context(this, this._ctx, this.state);
  ...
  public iriRef(): IriRefContext {
    const localctx: IriRefContext = new IriRefContext(this, this._ctx, this.state);
  ...
  public prefixedName(): PrefixedNameContext {
    const localctx: PrefixedNameContext = new PrefixedNameContext(this, this._ctx, this.state);
  ...
  public blankNode(): BlankNodeContext {
    const localctx: BlankNodeContext = new BlankNodeContext(this, this._ctx, this.state);
  ...
  public static readonly _serializedATN: number[] = [
    4, 1,
 1, 0, 0, 0, 392, 395, 1, 0, 0, 0, 393, 391, 1, 0, 0, 0, 393, 394, 1, 0, 0,
    0, 394, 69, 1, 0, 0, 0, 395, 393, 1, 0, 0, 0, 396, 397, 3, 80, 40, 0, 397, 71, 1, 0, 0, 0, 398, 401, 3, 84, 42, 0,
    399, 401, 5, 30, 0, 0, 400, 398, 1, 0, 0, 0, 400, 399, 1, 0, 0, 0, 401, 73, 1, 0, 0, 0, 402, 405, 3, 78, 39, 0, 403,
    405, 3, 76, 38, 0, 404, 402, 1, 0, 0, 0, 404, 403, 1, 0, 0, 0, 405, 75, 1, 0, 0, 0, 406, 407, 5, 31, 0, 0, 407, 408,
    3, 64, 32, 0, 408, 409, 5, 32, 0, 0, 409, 77, 1, 0, 0, 0, 410, 412, 5, 26, 0, 0, 411, 413, 3, 80, 40, 0, 412, 411,
    1, 0, 0, 0, 413, 414, 1, 0, 0, 0, 414, 412, 1, 0, 0, 0, 414, 415, 1, 0, 0, 0, 415, 416, 1, 0, 0, 0, 416, 417, 5, 28,
    0, 0, 417, 79, 1, 0, 0, 0, 418, 421, 3, 82, 41, 0, 419, 421, 3, 74, 37, 0, 420, 418, 1, 0, 0, 0, 420, 419, 1, 0, 0,
    0, 421, 81, 1, 0, 0, 0, 422, 425, 3, 86, 43, 0, 423, 425, 3, 88, 44, 0, 424, 422, 1, 0, 0, 0, 424, 423, 1, 0, 0, 0,
    425, 83, 1, 0, 0, 0, 426, 429, 3, 86, 43, 0, 427, 429, 3, 132, 66, 0, 428, 426, 1, 0, 0, 0, 428, 427, 1, 0, 0, 0,
    429, 85, 1, 0, 0, 0, 430, 431, 7, 2, 0, 0, 431, 87, 1, 0, 0, 0, 432, 439, 3, 132, 66, 0, 433, 439, 3, 118, 59, 0,
    434, 439, 3, 120, 60, 0, 435, 439, 3, 128, 64, 0, 436, 439, 3, 136, 68, 0, 437, 439, 5, 81, 0, 0, 438, 432, 1, 0, 0,
    0, 438, 433, 1, 0, 0, 0, 438, 434, 1, 0, 0, 0, 438, 435, 1, 0, 0, 0, 438, 436, 1, 0, 0, 0, 438, 437, 1, 0, 0, 0,
    439, 89, 1, 0, 0, 0, 440, 441, 3, 92, 46, 0, 441, 91, 1, 0, 0, 0, 442, 447, 3, 94, 47, 0, 443, 444, 5, 33, 0, 0,
    444, 446, 3, 94, 47, 0, 445, 443, 1, 0, 0, 0, 446, 449, 1, 0, 0, 0, 447, 445, 1, 0, 0, 0, 447, 448, 1, 0, 0, 0, 448,
    93, 1, 0, 0, 0, 449, 447, 1, 0, 0, 0, 450, 455, 3, 96, 48, 0, 451, 452, 5, 34, 0, 0, 452, 454, 3, 96, 48, 0, 453,
    451, 1, 0, 0, 0, 454, 457, 1, 0, 0, 0, 455, 453, 1, 0, 0, 0, 455, 456, 1, 0, 0, 0, 456, 95, 1, 0, 0, 0, 457, 455, 1,
    0, 0, 0, 458, 459, 3, 98, 49, 0, 459, 97, 1, 0, 0, 0, 460, 473, 3, 100, 50, 0, 461, 462, 5, 35, 0, 0, 462, 474, 3,
    100, 50, 0, 463, 464, 5, 36, 0, 0, 464, 474, 3, 100, 50, 0, 465, 466, 5, 37, 0, 0, 466, 474, 3, 100, 50, 0, 467,
    468, 5, 38, 0, 0, 468, 474, 3, 100, 50, 0, 469, 470, 5, 39, 0, 0, 470, 474, 3, 100, 50, 0, 471, 472, 5, 40, 0, 0,
    472, 474, 3, 100, 50, 0, 473, 461, 1, 0, 0, 0, 473, 463, 1, 0, 0, 0, 473, 465, 1, 0, 0, 0, 473, 467, 1, 0, 0, 0,
    473, 469, 1, 0, 0, 0, 473, 471, 1, 0, 0, 0, 473, 474, 1, 0, 0, 0, 474, 99, 1, 0, 0, 0, 475, 476, 3, 102, 51, 0, 476,
    101, 1, 0, 0, 0, 477, 486, 3, 104, 52, 0, 478, 479, 5, 41, 0, 0, 479, 485, 3, 104, 52, 0, 480, 481, 5, 42, 0, 0,
    481, 485, 3, 104, 52, 0, 482, 485, 3, 124, 62, 0, 483, 485, 3, 126, 63, 0, 484, 478, 1, 0, 0, 0, 484, 480, 1, 0, 0,
    0, 484, 482, 1, 0, 0, 0, 484, 483, 1, 0, 0, 0, 485, 488, 1, 0, 0, 0, 486, 484, 1, 0, 0, 0, 486, 487, 1, 0, 0, 0,
    487, 103, 1, 0, 0, 0, 488, 486, 1, 0, 0, 0, 489, 496, 3, 106, 53, 0, 490, 491, 5, 6, 0, 0, 491, 495, 3, 106, 53, 0,
    492, 493, 5, 43, 0, 0, 493, 495, 3, 106, 53, 0, 494, 490, 1, 0, 0, 0, 494, 492, 1, 0, 0, 0, 495, 498, 1, 0, 0, 0,
    496, 494, 1, 0, 0, 0, 496, 497, 1, 0, 0, 0, 497, 105, 1, 0, 0, 0, 498, 496, 1, 0, 0, 0, 499, 500, 5, 44, 0, 0, 500,
    507, 3, 108, 54, 0, 501, 502, 5, 41, 0, 0, 502, 507, 3, 108, 54, 0, 503, 504, 5, 42, 0, 0, 504, 507, 3, 108, 54, 0,
    505, 507, 3, 108, 54, 0, 506, 499, 1, 0, 0, 0, 506, 501, 1, 0, 0, 0, 506, 503, 1, 0, 0, 0, 506, 505, 1, 0, 0, 0,
    507, 107, 1, 0, 0, 0, 508, 516, 3, 110, 55, 0, 509, 516, 3, 112, 56, 0, 510, 516, 3, 116, 58, 0, 511, 516, 3, 118,
    59, 0, 512, 516, 3, 120, 60, 0, 513, 516, 3, 128, 64, 0, 514, 516, 3, 86, 43, 0, 515, 508, 1, 0, 0, 0, 515, 509, 1,
    0, 0, 0, 515, 510, 1, 0, 0, 0, 515, 511, 1, 0, 0, 0, 515, 512, 1, 0, 0, 0, 515, 513, 1, 0, 0, 0, 515, 514, 1, 0, 0,
    0, 516, 109, 1, 0, 0, 0, 517, 518, 5, 26, 0, 0, 518, 519, 3, 90, 45, 0, 519, 520, 5, 28, 0, 0, 520, 111, 1, 0, 0, 0,
    521, 522, 5, 45, 0, 0, 522, 523, 5, 26, 0, 0, 523, 524, 3, 90, 45, 0, 524, 525, 5, 28, 0, 0, 525, 577, 1, 0, 0, 0,
    526, 527, 5, 46, 0, 0, 527, 528, 5, 26, 0, 0, 528, 529, 3, 90, 45, 0, 529, 530, 5, 28, 0, 0, 530, 577, 1, 0, 0, 0,
    531, 532, 5, 47, 0, 0, 532, 533, 5, 26, 0, 0, 533, 534, 3, 90, 45, 0, 534, 535, 5, 27, 0, 0, 535, 536, 3, 90, 45, 0,
    536, 537, 5, 28, 0, 0, 537, 577, 1, 0, 0, 0, 538, 539, 5, 48, 0, 0, 539, 540, 5, 26, 0, 0, 540, 541, 3, 90, 45, 0,
    541, 542, 5, 28, 0, 0, 542, 577, 1, 0, 0, 0, 543, 544, 5, 49, 0, 0, 544, 545, 5, 26, 0, 0, 545, 546, 3, 86, 43, 0,
    546, 547, 5, 28, 0, 0, 547, 577, 1, 0, 0, 0, 548, 549, 5, 50, 0, 0, 549, 550, 5, 26, 0, 0, 550, 551, 3, 90, 45, 0,
    551, 552, 5, 27, 0, 0, 552, 553, 3, 90, 45, 0, 553, 554, 5, 28, 0, 0, 554, 577, 1, 0, 0, 0, 555, 556, 5, 51, 0, 0,
    556, 557, 5, 26, 0, 0, 557, 558, 3, 90, 45, 0, 558, 559, 5, 28, 0, 0, 559, 577, 1, 0, 0, 0, 560, 561, 5, 52, 0, 0,
    561, 562, 5, 26, 0, 0, 562, 563, 3, 90, 45, 0, 563, 564, 5, 28, 0, 0, 564, 577, 1, 0, 0, 0, 565, 566, 5, 53, 0, 0,
    566, 567, 5, 26, 0, 0, 567, 568, 3, 90, 45, 0, 568, 569, 5, 28, 0, 0, 569, 577, 1, 0, 0, 0, 570, 571, 5, 54, 0, 0,
    571, 572, 5, 26, 0, 0, 572, 573, 3, 90, 45, 0, 573, 574, 5, 28, 0, 0, 574, 577, 1, 0, 0, 0, 575, 577, 3, 114, 57, 0,
    576, 521, 1, 0, 0, 0, 576, 526, 1, 0, 0, 0, 576, 531, 1, 0, 0, 0, 576, 538, 1, 0, 0, 0, 576, 543, 1, 0, 0, 0, 576,
    548, 1, 0, 0, 0, 576, 555, 1, 0, 0, 0, 576, 560, 1, 0, 0, 0, 576, 565, 1, 0, 0, 0, 576, 570, 1, 0, 0, 0, 576, 575,
    1, 0, 0, 0, 577, 113, 1, 0, 0, 0, 578, 579, 5, 55, 0, 0, 579, 580, 5, 26, 0, 0, 580, 581, 3, 90, 45, 0, 581, 582, 5,
    27, 0, 0, 582, 585, 3, 90, 45, 0, 583, 584, 5, 27, 0, 0, 584, 586, 3, 90, 45, 0, 585, 583, 1, 0, 0, 0, 585, 586, 1,
    0, 0, 0, 586, 587, 1, 0, 0, 0, 587, 588, 5, 28, 0, 0, 588, 115, 1, 0, 0, 0, 589, 591, 3, 132, 66, 0, 590, 592, 3,
    56, 28, 0, 591, 590, 1, 0, 0, 0, 591, 592, 1, 0, 0, 0, 592, 117, 1, 0, 0, 0, 593, 597, 3, 130, 65, 0, 594, 598, 5,
    65, 0, 0, 595, 596, 5, 56, 0, 0, 596, 598, 3, 132, 66, 0, 597, 594, 1, 0, 0, 0, 597, 595, 1, 0, 0, 0, 597, 598, 1,
    0, 0, 0, 598, 119, 1, 0, 0, 0, 599, 603, 3, 122, 61, 0, 600, 603, 3, 124, 62, 0, 601, 603, 3, 126, 63, 0, 602, 599,
    1, 0, 0, 0, 602, 600, 1, 0, 0, 0, 602, 601, 1, 0, 0, 0, 603, 121, 1, 0, 0, 0, 604, 605, 7, 3, 0, 0, 605, 123, 1, 0,
    0, 0, 606, 607, 7, 4, 0, 0, 607, 125, 1, 0, 0, 0, 608, 609, 7, 5, 0, 0, 609, 127, 1, 0, 0, 0, 610, 611, 7, 6, 0, 0,
    611, 129, 1, 0, 0, 0, 612, 613, 7, 7, 0, 0, 613, 131, 1, 0, 0, 0, 614, 617, 5, 59, 0, 0, 615, 617, 3, 134, 67, 0,
    616, 614, 1, 0, 0, 0, 616, 615, 1, 0, 0, 0, 617, 133, 1, 0, 0, 0, 618, 619, 7, 8, 0, 0, 619, 135, 1, 0, 0, 0, 620,
    621, 7, 9, 0, 0, 621, 137, 1, 0, 0, 0, 65, 143, 148, 153, 165, 170, 173, 178, 189, 199, 202, 207, 211, 219, 227,
    237, 242, 245, 249, 253, 255, 262, 268, 270, 280, 284, 287, 290, 294, 302, 304, 309, 323, 332, 344, 349, 353, 360,
    362, 370, 378, 382, 386, 393, 400, 404, 414, 420, 424, 428, 438, 447, 455, 473, 484, 486, 494, 496, 506, 515, 576,
    585, 591, 597, 602, 616,
  ];
  ...
  static DecisionsToDFA = SparqlParser._ATN.decisionToState.map(
